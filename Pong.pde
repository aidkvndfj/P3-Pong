...
void ballBounce(){
  if((ball.x < paddle1.x+7 && ball.x > paddle1.x-7 && ball.y < paddle1.y+50 && ball.y > paddle1.y-50)|| (ball.x > paddle2.x-7 && ball.x < paddle2.x+7 && ball.y < paddle2.y+50 && ball.y > paddle2.y-50)){
    direction *= -1;
  }
...
void paddleRDraw(){
  ...
  stroke(255);
  rectMode(CENTER);
  rect(paddle2.x, paddle2.y, 15, 100);
}
...
void paddleLDraw(){
  ...
  stroke(255);
  rectMode(CENTER);
  rect(paddle1.x, paddle1.y, 15, 100);
}
...
void printScore(){
  ...
  */
  ...
  line(450, 100, 490, 100);
  fill(255);
  text("Player 1 Wins", 360, 430);
  noLoop();
  }
  
  if (p2 == 0){
  line(450 + a, 20, 490 + a, 20);
  line(450 + a, 100, 490 + a, 100);
  line(450 + a, 20, 450 + a, 60);
  line(490 + a, 20, 490 + a, 60);
  line(450 + a, 60, 450 + a, 100);
  line(490 + a, 60, 490 + a, 100);
  }else if(p2 == 1){   
  line(490 + a, 20, 490 + a, 60);
  line(490 + a, 60, 490 + a, 100);
  }else if(p2 == 2){
